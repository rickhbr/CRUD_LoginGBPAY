class PaymentLocationScreenText {
  static const String title = 'Endereço da Fatura do Cartão';
  ...
  static getStates() {
    ...
    PaymentLocationScreenText.listOfStates.sort((a, b) {
